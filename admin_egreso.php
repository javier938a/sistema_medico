<?php
	include ("_core.php");
	// Page setup
	$title='Administrar Salidas de Efectivo';
	$_PAGE = array ();
	$_PAGE ['title'] =$title;
	$_PAGE ['links'] = null;
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				$filename = "salida_caja.php";
				$links=permission_usr($id_user,$filename);
				if($links!='NOT' || $admin=='1')
					echo "<a class='btn btn-primary' href='salida_caja.php'><i class='fa fa-plus'></i> Salida Caja</a>";
				?>
...
<?php    
include("footer.php"); 
echo" <script type='text/javascript' src='js/funciones/funciones_egreso_dt.js'></script>"; 
} //permiso del script
else
{
