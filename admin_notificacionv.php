	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				$links=permission_usr($id_user, $filename);
				if($links != 'NOT' || $admin = '1')
					echo "<a class='btn btn-primary' role='button' href='generar_notificacionv.php'><i class='fa fa-plus icon-large'></i> Generar Notificaciones</a>";
				echo "</div>";
				?>
...
<?php    
	include("footer.php");
	echo" <script type='text/javascript' src='js/funciones/funciones_notificacionv.js'></script>"; 
	} //permiso del script
else {
