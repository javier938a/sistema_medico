<?php
	...
	include_once "main_menu.php";
 	...
 	$sql="SELECT d.*, e.descripcion FROM doctor AS d, especialidad as e WHERE d.id_especialidad = e.id_especialidad";
	$result=_query($sql);
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='agregar_doctor.php' class='btn btn-primary' role='button' id='add_doc'><i class='fa fa-plus icon-large'></i> Agregar médico</a>";
