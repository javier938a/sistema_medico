...
var id_usb_enviar = '1';
var tabla_buscar_enviar = 'insumos_emergencia';
var id_servicio_buscar = '4';
...
function reload1() {
    location.href = 'admin_emergencia.php';
}
...
function generar2(datax) {
    ...
    dataTable = $('#editableRecepcion').DataTable({
        ...
        "autoWidth": false,
        "ajax": {
            url: "admin_emergencia_dt.php?fechai=" + fechai + "&fechaf=" + fechaf, // json datasource
