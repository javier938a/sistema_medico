...
function initial() {
    ...
    $_PAGE ['links'] .= '<link href="css/plugins/summernote/summernote.css" rel="stylesheet">';
    $_PAGE ['links'] .= '<link href="css/plugins/summernote/summernote-bs3.css" rel="stylesheet">';
    ...
    $query = _query("SELECT * FROM examen_ultrasonografia WHERE id_examen_paciente ='$id_examen_paciente'");
    $num = _num_rows($query);
    if($num>0)
    {
        $datos = _fetch_array($query);
        $resultado = $datos["resultado"];
        $id_examen = $datos["id_ultrasonografia"];
        $fecha = $datos["fecha"];
    }
    else
    {
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group has-info">
                                        ...
                                        <textarea name="resultado" id="resultado" class="form-control bordes-input read summernote" rows="8" <?php if($num>0){ echo "readonly";} ?>><?php echo $resultado; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="title-action" id='botones'>
                            <input type="hidden" name="process" id="process" value="ultra">
...
function insert()
{
    ...
    if($id_examen>0)
    {
        $where = "id_ultrasonografia='$id_examen'";
