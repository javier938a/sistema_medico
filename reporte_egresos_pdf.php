...
class PDF extends PDF_HTML_Table
{
  ...
  public $weights=array(10,30,60,60,25);
...
$tableData=array("No.","FECHA","RESPONSABLE","CONCEPTO", "TOTAL");
...
$htmlTable="<TABLE>";
//sql stock antiguo
$sql="SELECT  * FROM egreso WHERE  fecha BETWEEN '$fi' AND '$ff' ORDER BY fecha ASC";
