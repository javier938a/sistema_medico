...
function insertar()
{
    ...
    $sql_exis = _query("SELECT * FROM espacio WHERE descripcion='$descripcion'");
    ...
    if($num_exis==0)
    {
        ...
        if($insertar)
        {
            ...
            $xdatos['msg']='Consultorio ingresado correctamente';
            $xdatos['process']='insert';
        }
        else
        {
            $xdatos['typeinfo']='Error';
            $xdatos['msg']='Consultorio no pudo ser ingresado';
        }
    }
    else
    {
        $xdatos['typeinfo']='Error';
        $xdatos['msg']='Este Consultorio ya fue ingresado';
    }    
