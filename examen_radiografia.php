...
function initial() {
    ...
    $query = _query("SELECT * FROM examen_radiografia WHERE id_examen_paciente ='$id_examen_paciente'");
    $num = _num_rows($query);
    if($num>0)
    {
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="title-action" id='botones'>
                            <input type="hidden" name="process" id="process" value="rx">
...
function insert()
{
    ...
    if($id_examen>0)
    {
        $where = "id_radiografia='$id_examen'";
