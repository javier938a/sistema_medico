...
function initial() {
    ...
    $query_user = _query("SELECT * FROM usuario WHERE id_usuario='$id_usuario'");
    $datos_user = _fetch_array($query_user);
    $nombre = $datos_user["nombre"];
    $usuario = $datos_user["usuario"];
    $tipo = $datos_user["tipo_usuario"];
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select id="tipo" name="tipo" class="form-control select" >
                                            ...
                                            <?php
                                                $sql = _query("SELECT * FROM tipo_usuario ORDER BY id_tipo DESC");
...
function editar_usuario()
{
    ...
    $activo=$_POST["activo"];
    $sql_result=_query("SELECT id_usuario FROM usuario WHERE usuario='$usuario' AND id_usuario!='$id_usuario'");
