<?php
	include ("_core.php");
	// Page setup
	$title='Administrar Tipo de Habitaciones';
	$_PAGE = array ();
	$_PAGE ['title'] =$title;
	$_PAGE ['links'] = null;
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				$filename='agregar_tipo_habitacion.php';
				$link=permission_usr($id_user,$filename);
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='agregar_tipo_habitacion.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Tipo de Habitacion</a>";
...
<?php
    include("footer.php");
    echo" <script type='text/javascript' src='js/funciones/funciones_tipo_habitacion.js'></script>";
} //permiso del script
else
{
