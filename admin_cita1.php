				...
				<div class="ibox-content">
					...
					<div class="row">
						...
						<div class="col-lg-5">
							<div class="form-group has-info">
								<label>HASTA</label>
								<input type="text" name="hasta" id="hasta" class="form-control datepicker" value="<?php echo $ini;?>">
							</div>
						</div>
						<div class="col-lg-2">
...
<?php    
include("footer.php");
echo" <script type='text/javascript' src='js/funciones/funciones_cita1_dt.js'></script>"; 
} //permiso del script
else
{
