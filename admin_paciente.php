<?php
	...
	include_once "main_menu.php";
 	...
 	$sql="SELECT p.*, d.nombre_departamento, m.nombre_municipio FROM paciente AS p, departamento AS d, municipio AS m WHERE p.municipio = m.id_municipio AND m.id_departamento_municipio = d.id_departamento";
	$result=_query($sql);
	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='agregar_paciente.php' class='btn btn-primary begin' role='button' id='btn'><i class='fa fa-plus icon-large'></i> Agregar Paciente</a>";
