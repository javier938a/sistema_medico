	...
	<div class="row" id="row1">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				$filename='agregar_examen.php';
				$link=permission_usr($id_user,$filename);
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='agregar_examen.php' class='btn btn-primary' role='button' id='btn'><i class='fa fa-plus icon-large'></i> Agregar Examen</a>";
				...
				<div class="ibox-content">
					...
					<section>
						<table class="table table-striped table-bordered table-hover" id="editable">
							<thead>
								<tr>
									<th style="width: 15%;">Id Examen</th>
						...
						for($i=0;$i<$count;$i++)
						{
							...
							echo"<td><div class=\"btn-group\">
								...
								<ul class=\"dropdown-menu dropdown-primary\">";
									...
									$link=permission_usr($id_user,$filename);
									if ($link!='NOT' || $admin=='1' )
										echo "<li><a data-toggle='modal' href='borrar_examen.php?id_examen=".$row ['id_examen']."&process=formDelete"."' data-target='#deleteModal' data-refresh='true'><i class=\"fa fa-eraser\"></i> Eliminar</a></li>";
							echo "	</ul>
										</div>
										</td>
										</tr>";
